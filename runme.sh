...
DATASET_DIR="/data/uni0/users/furukawa/maestro-v3.0.0"

# Modify to your workspace
WORKSPACE="/data/uni0/users/furukawa/piano_transcription"
...
#python3 pytorch/main.py train --workspace=$WORKSPACE --model_type='Regress_onset_offset_frame_velocity_CRNN' --loss_type='regress_onset_offset_frame_velocity_bce' --augmentation='none' --max_note_shift=0 --batch_size=24 --learning_rate=5e-4 --reduce_iteration=10000 --resume_iteration=0 --early_stop=150000 --cuda

# --- 2. Train pedal transcription system ---
python3 pytorch/main.py train --workspace=$WORKSPACE --model_type='Regress_pedal_CRNN' --loss_type='regress_pedal_bce' --augmentation='none' --max_note_shift=0 --batch_size=12 --learning_rate=5e-4 --reduce_iteration=10000 --resume_iteration=0 --early_stop=150000 --cuda
